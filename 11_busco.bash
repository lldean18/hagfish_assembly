...
assembly_dir=flye_1/assembly_ragtag
assembly=ragtag.scaffold.fasta

#assembly_dir=Eptatretus_burgeri_ref
#assembly=FYBX03.fasta.gz

#assembly_dir=Eptatretus_atami_ref
#assembly=JAXMNL01.fasta.gz
